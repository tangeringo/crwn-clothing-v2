...
export const uploadDataToFirestoreDb = async (collectionKey, objectsToAdd) => {
...
export const getCollectionsDataFromFirestoreDb = async () => {
...
export const createUserDocFromAuth = async (userAuth, additionalInfo = {}) => {
    ...
    console.log('users Data: ', userDocRef)

    const userSnapShot = await getDoc(userDocRef)
    console.log('users SnapShot: ', userSnapShot)
    console.log('users SnapShot: ', userSnapShot.exists())
